...
```{r sites}
sites <- data.frame(
  name = c("Denisova","Chagyrskaya","Vindija", "Mezmaiskaya", "Buran-Kaya III", 
  ...
  samples = c("Denisova 3 (Denisovan)\nDenisova 11 (F1 Hybrid)\n Denisova 5 (Neanderthal)\n Denisova 25 (Denisovan)",
    ...
    "Spy 94-a",
    "Les Cottés Z4-1415"),
  lon  = c(84.7, 83.1, 16.8, 40, 35.0, -5.3, 4.7, 2.5), #E (+) W (-)
  lat  = c(51.4, 51.3, 46.3, 44.1, 45.0, 43.4, 50.5, 46.2) #N (+) S (-)
)
