...
depth_all <- depth_all %>%
  mutate(
    ...
    Sample = factor(Sample, levels = c("Scladina", "Denisova 11 (Denny)", "Mez1", "Mez2", "HST", "Spy", "les Cottes", "Denisova 5 (Altai Neanderthal)", "Chagyrskaya 8", "Vindija 87", "Denisova 25"))
  )
```

```{r depth_viz}
wes_samples <- wes_palette("Zissou1", 15, type = "continuous")
