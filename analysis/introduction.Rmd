...
den5$Sample <- "Altai Neanderthal"

depth_all <- bind_rows(scladina, denny, mez1, mez2, hstadel, spy, lescottes, den5)

depth_all <- depth_all %>%
  mutate(
    Chromosome = factor(Chromosome, levels = unique(Chromosome)),
    Sample = factor(Sample, levels = c("Scladina", "Denny", "Mez1", "Mez2", "HST", "Spy", "les Cottes", "Altai Neanderthal"))
  )
```
